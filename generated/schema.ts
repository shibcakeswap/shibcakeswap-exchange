...
export class ShibcakeFactory extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save ShibcakeFactory entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save ShibcakeFactory entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("ShibcakeFactory", id.toString(), this);
  }

  static load(id: string): ShibcakeFactory | null {
    return store.get("ShibcakeFactory", id) as ShibcakeFactory | null;
  }
...
export class ShibcakeDayData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save ShibcakeDayData entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save ShibcakeDayData entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("ShibcakeDayData", id.toString(), this);
  }

  static load(id: string): ShibcakeDayData | null {
    return store.get("ShibcakeDayData", id) as ShibcakeDayData | null;
  }

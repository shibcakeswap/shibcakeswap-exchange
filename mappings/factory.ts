...
import { ShibcakeFactory, Pair, Token, Bundle } from "../generated/schema";
...
export function handlePairCreated(event: PairCreated): void {
  let factory = ShibcakeFactory.load(FACTORY_ADDRESS);
  if (factory === null) {
    factory = new ShibcakeFactory(FACTORY_ADDRESS);
